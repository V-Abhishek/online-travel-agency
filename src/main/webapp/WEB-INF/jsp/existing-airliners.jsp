<%-- 
    Document   : existing-airliners
    Created on : Apr 19, 2020, 2:00:10 PM
    Author     : Abhishek
--%>
...
<html>
    ...
    <head>
        ...
        <title>Existing Airliners</title>
    </head>
    <body>
        <h1 align="center">Existing Airliners</h1>
        <c:choose>
            <c:when test="${empty requestList}">
                <h2 align="center">No Pending Requests</h2>
            </c:when>
            <c:otherwise>
                <form action="traveladmin.htm" method="post" onsubmit="return validateForm();">
                    <table id="customers">
                        <thead>
                            <tr>
                                <th>Airliner</th>
                        ...
                        <tbody>
                            <c:forEach items="${requestList}" var = "airliner">
                                <tr>
                                    ...
                                    <td><input type="checkbox" name="deleteIds" value="${airliner.id}"/>Remove</td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
                    <input type="hidden" name="action" value="deleteAirlinerAccounts">
    ...
    <script>
        ...
        function validateForm() {
            if (count>0) {
                ...
                alert('No accounts selected to delete');
                return false;
            }
        }
